...
CREATE TABLE if not exists gemsrnd__randomization_values (
        ...
        grv_value               varchar(30) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' not null,
        grv_value_label         varchar(30) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' not null,
        ...
        grv_created             timestamp not null default current_timestamp,
