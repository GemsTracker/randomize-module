...
CREATE TABLE if not exists gemsrnd__randomization_blocks (
        ...
        grb_block_id            varchar(30) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' not null,

        grb_condition           bigint unsigned null references gems__conditions (gcon_id),

        grb_value_id            varchar(30) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' not null references gemsrnd__randomization_values (grv_value_id),
        ...
        grb_block_description   varchar(30) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null,
        grb_block_info          varchar(50) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' null,
        ...
        grb_created             timestamp not null default current_timestamp,
